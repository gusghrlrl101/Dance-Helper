...
for i in range(1, 21):
	...
	#pt1 = ((int)(json_string[i*3]),(int)(json_string[i*3+1]))
	#pt2 = ((int)(json_string2[i*3]),(int)(json_string2[i*3+1]))
	pt1 = (200,320)
	pt2 = (300,400)
	cv2.arrowedLine(source,pt1, pt2, (0,0,255),5)
	pt3 = (393, 672)
	pt4 = (409, 494)
	cv2.arrowedLine(source,pt3,pt4,(0,0,255),5)
        if(json_string2[i*3]-json_string[i*3]>0):
            print(str(indiInfo[i])+"를 왼쪽"),
        else:
            print(str(indiInfo[i])+"를 오른쪽"),
